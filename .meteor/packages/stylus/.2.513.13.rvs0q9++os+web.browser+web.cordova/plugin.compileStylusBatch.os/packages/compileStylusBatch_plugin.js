...
var require = meteorInstall({"node_modules":{"meteor":{"compileStylusBatch":{"plugin":{"compile-stylus.js":function(require){

///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                               //
// packages/compileStylusBatch/plugin/compile-stylus.js                                                          //
//                                                                                                               //
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                 //
...
Plugin.registerCompiler({
  extensions: ['styl'],
  archMatching: 'web'
}, () => new StylusCompiler()); // CompileResult is {css, sourceMap}.
...
class StylusCompiler extends MultiFileCachingCompiler {
  ...
  getCacheKey(inputFile) {
    return [inputFile.getSourceHash(), inputFile.getFileOptions()];
  }
  ...
  compileOneFile(inputFile, allFiles) {
    ...
    function parseImportPath(filePath, importerDir) {
      ...
      if (!filePath.match(/^\{.*\}\//)) {
        ...
        const parsedImporter = parseImportPath(importerDir, null); // resolve path if it is absolute or relative

        const importPath = filePath[0] === '/' ? filePath : path.join(parsedImporter.pathInPackage, filePath);
        return {
    ...
    style = style.set('filename', inputFile.getPathInPackage()).set('sourcemap', {
      inline: false,
      comment: false
    }).set('cache', false).set('importer', importer);
...
require("./node_modules/meteor/compileStylusBatch/plugin/compile-stylus.js");

/* Exports */
if (typeof Package === 'undefined') Package = {};
Package.compileStylusBatch = {};
...
//# sourceURL=meteor://💻app/packages/compileStylusBatch_plugin.js


//# sourceMappingURL=compileStylusBatch_plugin.js.map

...
var Profile = require('./profile.js').Profile; // TL;DR: Isopacket is a set of isopacks. Isopackets are used only inside
// meteor-tool.
...
function loadIsopackage(packageName, isopacketName = "combined") {

...
_.extend(Progress.prototype, {
  ...
  getCurrentProgress: function () {
    ...
    if (!self._state.done && self._state.current != 0 && self._state.end && !isRoot) {
  ...
  reportProgress: function (state) {
    ...
    self._updateTotalState(); // Nudge the spinner/progress bar, but don't yield (might not be safe to yield)

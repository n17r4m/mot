...
let watchLibrary;
module.watch(require("pathwatcher"), {
  "*"(v) {
    watchLibrary = v;
  }
...
let statOrNull, pathDirname, pathResolve, convertToOSPath, convertToStandardPath, watchFile, unwatchFile;
...
function startNewWatcher(absPath) {
  ...
  let watcher; // Determines the polling interval to be used for the fs.watchFile-based
  ...
  function watchWrapper(event) {
    ...
    fire.call(this, event); // It's tempting to call unwatchFile(absPath, watchFileWrapper) here,

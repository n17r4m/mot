...
var require = meteorInstall({"node_modules":{"meteor":{"compileLessBatch":{"plugin":{"compile-less.js":function(require){

//////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                          //
// packages/compileLessBatch/plugin/compile-less.js                                         //
//                                                                                          //
//////////////////////////////////////////////////////////////////////////////////////////////
                                                                                            //
...
Plugin.registerCompiler({
  ...
  archMatching: 'web'
}, () => new LessCompiler()); // CompileResult is {css, sourceMap}.
...
class MeteorImportLessPlugin {
  ...
  install(less, pluginManager) {
    pluginManager.addFileManager(new MeteorImportLessFileManager(this.allFiles));
  }
...
class MeteorImportLessFileManager extends less.AbstractFileManager {
  ...
  loadFile(filename, currentDirectory, options, environment, cb) {
    ...
    if (!this.allFiles.has(resolvedFilename)) {
      cb({
        type: 'File',
        message: 'Unknown import: ' + filename
      });
      return;
    }
...
require("./node_modules/meteor/compileLessBatch/plugin/compile-less.js");

/* Exports */
if (typeof Package === 'undefined') Package = {};
Package.compileLessBatch = {};
...
//# sourceURL=meteor://💻app/packages/compileLessBatch_plugin.js


//# sourceMappingURL=compileLessBatch_plugin.js.map

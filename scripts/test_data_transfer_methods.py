...
def main():
    target_vid_path = "/home/mot/data/source/Glass.Bead.Tests/300.to.335.um/MSBOT-010360000023.avi"
    ...
    pickled = RandomFrameEmitterPipe(10000)
    ramdisk = RandomFrameEmitterRamdisk(10000)
...
class RandomFrameEmitterPipe(F):
    ...
    def setup(self, n_frames):
        ...
        video = np.random.randint(low=0,high=255,size=(self.n_frames, 1729, 2336,1),dtype=np.uint8)
        for frame in video:
            self.put(frame)

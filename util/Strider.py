...
class Strider(object):
    def __init__(self, opts):
        ...
        self.frame = self.cropper.normalizer.normalizeFrame(self.cropper.bg, self.frame) / 255.0
    ...
    def run(self):
        ...
        for y, row in enumerate(self.frame):
            ...
            acc = np.append(acc, self.CC.imageclassifier.predict(crops, batch_size=1168, verbose=True))
